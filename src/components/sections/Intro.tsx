  ...
  return (
    <section className="relative w-full min-h-fit md:min-h-screen flex flex-col justify-center px-6 md:px-16 py-16 sm:py-20 md:py-24 gap-5 sm:gap-6 md:gap-8">
      ...
      <div className="flex flex-col items-end w-full">
        <h2 className="font-nightwatch text-[clamp(2.25rem,8vw,7rem)] leading-none text-gold-radial-figma tracking-tight pt-2 sm:pt-3 md:pt-4">
          NAMASTE
        </h2>
      ...
      {/* ROW 2: I'M A INDIAN */}
      <div className="flex items-center gap-4 md:gap-8 w-full mt-2 sm:mt-3 md:mt-8">
        <h2 className="font-nightwatch text-[clamp(2.25rem,8vw,7rem)] leading-none text-gold-radial-figma tracking-tight whitespace-nowrap pt-2 sm:pt-3 md:pt-4">
          I&apos;M A INDIAN
        </h2>
      ...
      <div
        ...
        style={{ height: "calc(clamp(2.25rem, 8vw, 7rem) * 1.4)" }}
      >
        <AnimatePresence mode="wait">
          <motion.h2
            ...
            className="absolute inset-0 flex items-center justify-end font-nightwatch text-[clamp(2.25rem,8vw,7rem)] leading-none text-gold-radial-figma whitespace-nowrap"
          >
            {roles[roleIndex]}
          </motion.h2>
        </AnimatePresence>

...
export default function GetInTouch() {
  ...
  {/* Main Title: Name */}
  <h1 className="font-nightwatch leading-[1.2] py-4 tracking-[-0.02em] whitespace-nowrap text-gold-radial-figma cursor-default text-[clamp(2rem,6.67vw,6rem)] pr-2 md:pr-4">
    VINAYSREEYAPU
    <span
